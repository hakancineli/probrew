              ...
              <div key={reward.id} className="bg-gray-50 rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    <p className="text-lg font-bold text-brand-primary">{reward.pointsCost} puan</p>
                    {reward.validUntil && (
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-brand-secondary text-white py-2 px-4 rounded-md hover:bg-brand-primary transition-colors font-medium"
                >
                  Ödül Oluştur
                </button>
              </div>
