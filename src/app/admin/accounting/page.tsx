...
export default function AccountingPage() {
    return (
        <Suspense fallback={<div className="p-8 text-center text-brand-primary font-bold">Rapor Hazırlanıyor...</div>}>
            <AccountingContent />
        </Suspense>
    );
}
...
function AccountingContent() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div className="flex items-center w-full md:w-auto">
                    ...
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center">
                        <FaChartLine className="mr-3 text-brand-primary" />
            ...
            <div id="expense-transactions" ref={transactionsRef} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {userRole === 'MANAGER' ? (
                        ...
                        <form onSubmit={handleAddExpense} className="space-y-4">
                            <div className={(category === 'ADVANCE' || category === 'RENT') ? 'hidden' : ''}>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-primary bg-gray-50 focus:bg-white"
                    ...
                    <div className="bg-white rounded-lg shadow p-6 h-fit sticky top-6">
                        <h2 className="text-xl font-bold text-gray-800 flex items-center mb-4">
                            <FaChartLine className="mr-2 text-brand-primary" />
                            Rapor Özeti
                        </h2>
                ...
                isDetailModalOpen && selectedDate && (
                    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-fade-in">
                        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl h-[80vh] flex flex-col overflow-hidden">
                            <div className="bg-gradient-to-r from-brand-primary to-green-800 p-6 text-white flex justify-between items-center shrink-0">
                                <div>
                                                    ...
                                                    <>
                                                        ...
                                                        {[
                                                            ...
                                                            return (
                                                                <div
                                                                    key={item.id}
                                                                    className={`group rounded-xl border transition-all cursor-pointer ${isExpanded ? 'ring-2 ring-brand-primary border-brand-primary shadow-lg' : 'border-gray-100 hover:border-gray-200 hover:shadow-md'
                                                                            ...
                                                                            <div className="flex-1">
                                                                                ...
                                                                                <div className="mt-1 flex flex-col">
                                                                                    ...
                                                                                    {!isStaff && (item as any).staff?.name && (
                                                                                        <span className="text-[10px] text-brand-primary font-bold mt-0.5 flex items-center gap-1 uppercase tracking-wider">
